...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; opacity: 0.5; background: url('https://raw.githubusercontent.com/leexey/leexey/main/Helter%20Skelter%20(2012)%20(1).jpg') no-repeat center center fixed; background-size: cover;]{x0000}$}
